...
ActiveRecord::Schema[7.1].define(version: 2024_02_07_003735) do
  ...
  add_foreign_key "flight_routes", "airports", column: "arrival_airport_id"
  add_foreign_key "flight_routes", "airports", column: "departure_airport_id"
  add_foreign_key "flight_routes", "flights"
end
